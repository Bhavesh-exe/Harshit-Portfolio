      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DYNAMIC EDITS</h3>
              <h4>Travel & Social Media</h4>
              <p>
                Specializing in cinematic travel edits and fast-paced social
                media content with seamless transitions and speed ramping.
              </p>
              <h5>Focus Areas</h5>
              <div className="what-content-flex">
                <div className="what-tags">Travel Edits</div>
                ...
                <div className="what-tags">YouTube Content</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
